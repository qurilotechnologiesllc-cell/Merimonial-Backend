...
messageRoutes.post("/send-file", authenticateUser, upload.single("file"), sendFileMessage);
...
messageRoutes.get('/clearAllUnread', authenticateUser, clearAllUnread); // Optional
